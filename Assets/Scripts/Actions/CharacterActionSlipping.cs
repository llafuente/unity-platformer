...
namespace UnityPlatformer {
  ...
  public class CharacterActionSlipping: CharacterAction {
    ...
    public override int WantsToUpdate(float delta) {
      ...
      if (pc2d.collisions.below && pc2d.collisions.slopeAngle > pc2d.maxClimbAngle) {
        return -1;
      }
      return 0;
    }
    ...
    public override void PerformAction(float delta) {
      ...
      float increaseBy = -slopeDir.y * Mathf.Abs(character.gravity.y) * delta;

      character.velocity += slopeDir * increaseBy;
